...
<!-- Content -->
<div class="container-fluid">
	<form class="form-neon FormularioAjax" action="<?php SERVERURL; ?>ajax/usuarioAjax.php" method="POST" data-form="save" autocomplete="off">
		<fieldset>
				...
				<div class="row">
					<div class="col-12 col-md-4">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="usuario_dni_reg" id="usuario_dni" maxlength="20" required="">
						</div>
					</div>
					<div class="col-12 col-md-4">
						<div class="form-group">
							<label for="usuario_tipo_documento" class="bmd-label-floating">Tipo de Documento</label>
							<select class="form-control" name="usuario_tipo_documento_reg" id="usuario_tipo_documento" maxlength="20">
